...
import { EmbeddedNode, GapTag, OpenNodeTag } from '@bablr/agast-helpers/symbols';
...
export const State = class BABLRState extends WeakStackFrame {
  ...
  *emit() {
  ...
  branch() {
    ...
    let { source, context, balanced, spans, result, referenceTagPath, emitted, held, node } =
      baseState;
  ...
  accept() {
    ...
    parent.emitted = new TagPath(parent.emitted.path, accepted.emitted.childrenIndex);
